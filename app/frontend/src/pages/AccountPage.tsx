...
export default function AccountPage()
{
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-2xl border border-stone-100 shadow-sm p-6 flex items-center gap-5">
        <div className="w-16 h-16 rounded-full bg-emerald-100 flex items-center justify-center text-2xl shrink-0">
          🐢
        </div>
        <div>
          <p className="text-lg font-semibold text-stone-800">Guest User</p>
          <p className="text-sm text-stone-400 mt-0.5">Accounts coming soon — your data is stored locally</p>
        </div>
      </div>
